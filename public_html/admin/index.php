          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-header">
                <center><h5 class="title">Đăng Nhập</h5></center>
              </div>
              <div class="card-body">
                <form id="login_form">
                  <div class="row">
                  ...
                  <div class="row center-element py-3">
                    <div class="col-md-8">
                      <div class="form-group">
                        <button class="btn btn-primary btn-block btn-round">Đăng Nhập</button>
                      </div>
                    </div>
                  </div>
                   <div class="row">
    ...
    $('#login_form').submit(function(event) {
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          {
            $("#result").html("Đăng nhập thất bại");
          }
        }
      });
    });
