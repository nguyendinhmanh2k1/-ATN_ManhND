          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Tạo bài kiểm tra mới</h5>
              </div>
              <div class="card-body">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Tên bài kiểm tra(tiêu đề)</label>
                          <input type="text" class="form-control" name="test_name" placeholder="Nhập tên" required/>
                      </div>
                      <div class="form-group">
                         <label>Tên chủ đề</label>
                          <input type="text" class="form-control" name="subject_name" placeholder="Nhập tên chủ đề" required/>
                      </div>
                      <div class="form-group">
                        <label>Ngày kiểm tra</label>
                          <input type="date" class="form-control" name="test_date" placeholder="Chọn ngày" required/>
                      </div>
                      <div class="form-group">
                        <label>Tổng số câu hỏi</label>
                          <input type="number" class="form-control" name="total_questions" placeholder="nhập tổng số câu hỏi" required/>
                      </div>
                      <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <select id="options" name="test_class" class="btn-round" required style="width:100%;">
                                  <option selected="true" value="" disabled="disabled">Chọn lớp kiểm tra</option>
                                  <?php
                  ...
                  <div class="row center-element">
                    <div class="col-md-8">
                      <div class="form-group">
                        <button class="btn btn-primary btn-block btn-round">TẠO BÀI KIỂM TRA</button>
                      </div>
                    </div>
                  </div>
                </form>
