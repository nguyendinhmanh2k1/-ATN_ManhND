          ...
          <div class="col-md-12">
            <div class="card" style="min-height:400px;">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-8">
                    <h5 class="title">Bài kiểm tra đang chờ</h5>
                  </div>
                  <div class="col-md-4">
                    <button class="btn btn-primary btn-block btn-round" onclick="redirect_to_new_test()" style="margin-top:0px;width:100px !important;float:right !important;">TẠO MỚI</button>
                  </div>
                </div>  
              </div>
              <div class="card-body">
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        ...
                        ?>
                          <div class="card" style="background:#ededed;">
                              <div class="card-body" onclick="submit(<?= $row['id'];?>)">
                                ...
                                <div class="row">
                                  <div class="col-md-8">
                                     <p>Chủ đề - <?= $row["subject"];?></p>
                                  </div>
                                  <div class="col-md-4"> 
                                   <p style="text-align:right;">Ngày - <?= $row["date"];?></p>
                                  </div>
                                </div>
                              </div>
                          </div>
                      ...
                      <div id="no-data">
                        <center>
                          ...
                          <center><h5>Không có dữ liệu</h5></center>
                        </center>
                      </div>
                      <?php
                    }
